$(function(){
    ...
    mista.forEach(function(obj, idx){
        console.log(obj.photo);
        kviz.append('<div class="col-sm-4"><figure id="'+idx+'"><img src="img/misto0.jpg"><figcaption>'
        +obj.name+'</figcaption></figure></div>');
    });
    
    var photo = $('#kviz img');
    photo.on('click',function(){
        var index = Math.floor(Math.random()*mista.length);
        $(this).attr('src','img/'+mista[index].photo)
               .attr('alt',mista[index].name);
    });
